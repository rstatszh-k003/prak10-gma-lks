...
einkaeufe <- read.csv(file = "/cloud/project/data/supermarkt/einkaeufe.csv")
preise <- read.csv(file = "/cloud/project/data/supermarkt/preise.csv")
kundenprofile <- read.csv(file = "/cloud/project/data/supermarkt/kundenprofile.csv")
